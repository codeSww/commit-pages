/**
 * 声明：以下部分代码源自：https://github.com/tschaub/gh-pages
 */
 ...
 * @param {string} registry Repository URL.
 * @param {string} dir Target directory.
 * @param {string} branch Branch name.
 * @param {options} options All options.
 * @return {Promise<Git>} A promise.
 */
Git.clone = function clone(rConfig ,dir) {
  const {registry, branch, remote,git,depth} = rConfig
